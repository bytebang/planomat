...
public class Plane
{
	...
	// planning
	private Instant tsat = null; // Target Startup Approval Time
	private Duration pushback; 	 
	private Instant tobt = null; // Target Off Blocks Time

	// No-Arg ctor for cloning
	public Plane()
	{
	 ...
	 * @return
	 */
	@PlanningVariable(valueRangeProviderRefs = { "tsatOptions" })
